...
<span class="line"></span></code></pre></div><h2 id="_2-配置" tabindex="-1">2. 配置 <a class="header-anchor" href="#_2-配置" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 显示当前的Git配置</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_3-向暂存区添加-删除文件" tabindex="-1">3. 向暂存区添加 / 删除文件 <a class="header-anchor" href="#_3-向暂存区添加-删除文件" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 添加指定文件或指定目录到暂存区</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_4-代码提交" tabindex="-1">4. 代码提交 <a class="header-anchor" href="#_4-代码提交" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 提交暂存区到仓库区</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_6-标签" tabindex="-1">6. 标签 <a class="header-anchor" href="#_6-标签" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 列出所有 tag</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_7-查看信息" tabindex="-1">7. 查看信息 <a class="header-anchor" href="#_7-查看信息" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight has-diff" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 显示变更的文件</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_8-提交" tabindex="-1">8. 提交 <a class="header-anchor" href="#_8-提交" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 下载远程仓库的所有变动</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_9-撤销" tabindex="-1">9. 撤销 <a class="header-anchor" href="#_9-撤销" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 重置暂存区的指定文件，与上一次 commit 保持一致，但工作区不变</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_10-日志" tabindex="-1">10. 日志 <a class="header-anchor" href="#_10-日志" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 查看提交过的完整日志</span></span>
<span class="line"><span style="color:#FFCB6B;">git</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">log</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#FFCB6B;">git</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">reflog</span></span>
<span class="line"></span></code></pre></div><p><a href="https://www.ruanyifeng.com/blog/2015/12/git-cheat-sheet.html" target="_blank" rel="noreferrer">参考地址：阮一峰 -- 常用 Git 命令清单</a></p>`,24),t=[o];function e(c,r,y,i,C,D){return n(),a("div",null,t)}const d=s(p,[["render",e]]);export{F as __pageData,d as default};
