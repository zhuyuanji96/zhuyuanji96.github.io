...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'yj') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
```js
const obj = { name: 'yj', age: 18 }
Object.keys(obj) // ['name', 'age']
Object.values(obj) //  ['yj', 18]
Object.entries(obj) // [['name', 'yj'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'yj']]) // {name: 'yj'}

/* Map 转对象 */
const map = new Map([['name', 'yj']])
Object.fromEntries(map) // {name: 'yj'}

/* 将查询字符串转为对象 */
const params = 'name=yj&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'yj', age: '18'}
```
...
- **`||` 运算符**只要左侧是 [假值](/web-doc/js-conversions.html) 就会返回右侧的值
